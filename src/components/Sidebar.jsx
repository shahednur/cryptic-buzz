...
const Sidebar = () => {
    return (
        <>
            <div className="w-64 bg-gray-800 shadow h-screen sticky top-0 flex-col justify-between flex">
                <div className="px-8">
                    <div className="h-16 w-full flex items-center">
                        ...
                        <img className="w-20 h-16 mt-6 ml-6" src="https://cdn.pixabay.com/photo/2021/02/25/18/48/bitcoin-6049802__340.png" alt="bitcoin" />
                    </div>
                    <ul className="mt-12">
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <Link to="/cryptocurrencies" className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Cryptocurrencies</span>
                            </Link>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
